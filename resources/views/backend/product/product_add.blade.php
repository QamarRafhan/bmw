                        ...
                        <div class="col-lg-8">
                            <div class="border border-3 p-4 rounded">
                                <div class="mb-3">
                                    ...
                                    <input name="product_name" type="text" class="form-control" id="inputWheelsTitle"
                                           placeholder="Enter wheel title" required>
                                    <small style="color: #e20000" class="error" id="product_name-error"></small>

                                </div>
                                <div class="mb-3">
                                    <label for="inputProductTitle" class="form-label">Wheels Code</label>
                                    <input name="product_code" type="text" class="form-control" id="inputWheelsTitle"
                                           placeholder="Enter wheel code" required>
