...
@section('PageTitle', 'Add new wheel')
@section('plugins')
...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    <div class="breadcrumb-title pe-3">Wheels</div>
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add new wheel</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="card">
    <div class="card-body p-4">
        <h5 class="card-title">Add New Wheels</h5>
        <hr />
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="border border-3 p-4 rounded">
                            <div class="mb-3">
                                <label for="inputProductTitle" class="form-label">Wheels Name/Title</label>
                                <input name="product_name" type="text" class="form-control" id="inputWheelsTitle" placeholder="Enter wheel title" required>
                                <small style="color: #e20000" class="error" id="product_name-error"></small>

                            </div>
                           
                            <div class="mb-3">
                                <label for="inputWheelsDescription" class="form-label">Short Description</label>
                                <textarea name="product_short_description" class="form-control" id="inputWheelsDescription" rows="3" required></textarea>
                                <small style="color: #e20000" class="error" id="product_short_description-error"></small>

                            </div>
                            <div class="mb-3">
                                <label for="inputWheelsLongDescription" class="form-label">Detailed Description</label>
                            ...
                            <div class="row mb-3">
                                <label class="form-label">Wheels Thumbnail</label>
                                <div class="col-sm-12 text-secondary">
                                    <input name="product_thumbnail" id="product_thumbnail" class="form-control" type="file" required>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Wheels Images</label>
                    ...
                    <div class="col-lg-4">
                        <div class="border border-3 p-4 rounded">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <label for="inputWheelsType" class="form-label">Wheels Brand</label>
                                    <select name="brand_id" class="form-select" id="inputWheelsType">
                                ...
                                <div class="col-12">
                                    <label for="inputVendor" class="form-label">Wheels Category</label>
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="gridCheck3">Featured Wheels</label>
                                </div>
                                <div class="form-check">
                                ...
                                <div class="col-12">
                                    <input type="submit" class="btn btn-primary" value="Save Wheels" />
                                </div>
                            </div>
                        </div>
                    </div>
